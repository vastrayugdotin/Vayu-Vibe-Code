...
const MOCK_PRODUCT = {
  ...
  images: [
    {
      url: "https://placehold.co/800x1200/1B1640/F4F1EC?text=Surya+Tee+Front",
      alt: "Front view",
    },
    {
      url: "https://placehold.co/800x1200/0A0A0F/C9A84C?text=Surya+Tee+Back",
      alt: "Back view",
    },
    {
      url: "https://placehold.co/800x1200/1B1640/F4F1EC?text=Surya+Tee+Detail",
      alt: "Detail view",
    },
  ],
  variants: [
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
        ...
        <div className="w-full lg:w-[45%] flex flex-col pt-2 lg:pt-8">
          <div className="mb-8 border-b border-white/10 pb-8">
            ...
            <p className="text-sm text-eclipse-silver mt-2">
          ...
          <div className="grid grid-cols-2 gap-4 mb-10">
            <div className="bg-void-black border border-white/5 p-4 flex flex-col">
              <span className="text-xs text-stardust-white/50 uppercase tracking-widest mb-1 font-body">
                Ruling Planet
              </span>
              <span className="text-nebula-gold font-heading text-lg">
                {product.planet}
              </span>
            </div>
            <div className="bg-void-black border border-white/5 p-4 flex flex-col">
              ...
              <span className="text-stardust-white font-heading text-lg">
                {product.zodiac_sign}
              </span>
            </div>
            <div className="bg-void-black border border-white/5 p-4 flex flex-col">
            ...
            <div className="bg-void-black border border-white/5 p-4 flex flex-col">
              ...
              <span className="text-stardust-white font-heading text-lg truncate">
                {product.emotional_intention}
              </span>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <span className="font-body text-sm text-stardust-white uppercase tracking-widest">
                Select Size
              </span>
          ...
          {/* Description */}
          <div className="mb-10">
            <h3 className="font-body text-sm text-stardust-white uppercase tracking-widest mb-4">
              The Meaning
            </h3>
            <div
          ...
          <div className="border-t border-white/10 pt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <span className="text-xs text-stardust-white uppercase tracking-wider font-body">
                Free Shipping
                <br />
                Above ₹999
              </span>
